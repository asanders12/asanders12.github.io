(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 170, 6, 0.8);
        collectable.create(type.kennedi, 110, 500, 10, 0.7);
        collectable.create(type.max, 300, 207, 20, 0.6);
        collectable.create(type.db, 800, 200, 2, 0.4);
